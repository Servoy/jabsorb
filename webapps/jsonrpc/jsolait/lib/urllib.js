...
*/
Module("urllib","1.1.0", function(thisMod){
    /**
        Thrown if no request object could be instanciated.
    */
    thisMod.NoHTTPRequestObject=Class("NoHTTPRequestObject", Exception, function(thisClass, Super){
        /**
            Initializes the Exception.
            @param trace The error causing this exception.
        */
        thisClass.prototype.init=function(trace){
            Super.prototype.init.call(this, thisMod, "Could not create an HTTP request object", trace);
        }
    })
    ...
    */
    thisMod.RequestOpenFailed = Class("RequestOpenFailed", Exception, function(thisClass, Super){
        /**
            Initializes the Exception.
            @param trace The error causing this exception.
        */
        thisClass.prototype.init=function(trace){
            Super.prototype.init.call(this,thisMod,"Opening of HTTP request failed.", trace);
        }
    })
    ...
    */
    thisMod.SendFailed=Class("SendFailed", Exception, function(thisClass, Super){
         /**
            Initializes the Exception.
            @param trace The error causing this exception.
        */
        thisClass.prototype.init = function(trace){
            Super.prototype.init.call(this,thisMod,"Sending of HTTP request failed.", trace);
        }
    })
    ...
    */
    var ASVRequest=Class("ASVRequest", function(thisClass){
        /**
        ...
        */
        thisClass.prototype.open=function(type,url,async){
            if (async == false){
        ...
        */
        thisClass.prototype.setRequestHeader=function(name, value){
    ...
    */    
                ...
                try{ //to get MS HTTP request object
                    ...
                    try{// to get the old MS HTTP request object
                        ...
                        try{//to create the ASV request object.
                            ...
                            throw new thisMod.NoHTTPRequestObject("Neither Mozilla, IE nor ASV found. Can't do HTTP request without them.");
                        }
                    }
                }    
            }
    ...
    /**
        ...
        @return                     HTTP request object.
    */
    thisMod.sendRequest=function(type, url, user, pass, data, headers, callback){
        var async=false;
        ...
        try{
            ...
            throw new thisMod.RequestOpenFailed(e);
        }
        //set headers
        ...
        try{
            ...
            throw new thisMod.SendFailed(e);
        }
        return xmlhttp;
    }
    /**
        ...
        @return                     HTTP request object.
    */
    thisMod.getURL=function(url, user, pass, headers, callback) { 
        var a=  new Array("GET");
        for(var i=0;i<arguments.length;i++){
            a.push(arguments[i]);
        }
        return thisMod.sendRequest.apply(this,a)
    }
    /**
        ...
        @return                     HTTP request object.
    */
    thisMod.postURL=function(url, user, pass, data, headers, callback) { 
