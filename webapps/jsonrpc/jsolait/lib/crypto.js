...
Module("crypto", "0.1.1", function(thisMod){
    ...
    */
    thisMod.listDecrypters=function(){
        var c=[];
        for(var attr in String.prototype){
    ...
    */
    String.prototype.encrypt=function(crydec){
        ...
        if(String.prototype[n]){
            ...
            throw new Exception(thisMod, "Decrypter '%s' not found.".format(crydec));
        }
    }
    /**
        Decrypts a string.
    ...
    */
    String.prototype.decrypt=function(crydec){
        ...
        if(String.prototype[n]){
            ...
            throw new Exception(thisMod, "Encrypter '%s' not found.".format(crydec));
        }
    }
