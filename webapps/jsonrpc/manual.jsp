...
<%@ include file="header.jspinc" %>
    ...
    <p>This manual covers the architecture and implementation details of <%=appName%> and contains a reference guide to the various components and interfaces. Please start with the <a href="tutorial.html">tutorial</a> if want to get started quickly.</p>
    ...
    <p><%=appName%> consists of two main user visible components, the JSONRPCBridge and the JSONRPCServlet.</p>
...
<pre>{
  ...
  // do stuff here ...
    ...
    <p><%=appName%> in an ORB (Object Request Broker) with the ability to pass objects by reference and keep these references in the user's session.</p>
