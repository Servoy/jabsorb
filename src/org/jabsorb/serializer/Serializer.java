...
public interface Serializer extends Serializable {
     ...
     * Both for serialzing from java => json and deserializing from json => java.
     *
     ...
     *
     * @return that JSONObject or JSONArray that contains the json representation of the java object that was marshalled.
     *
