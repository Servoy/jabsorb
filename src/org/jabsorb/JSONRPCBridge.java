...
public class JSONRPCBridge implements Serializable
{
   ...
   * <p/>
   * Calling registerClass for a clazz again under the same name will have no
   * effect.
   * <p/>
   ...
   *                       <p/>
   *                       This can be used to restrict the exported methods
   *                       to the methods defined in a specific superclass or
   *                       interface.
   */
   ...
   * instead be resolved locally using context information from the
   * transport.
   *
   * @param argClazz         The class to be resolved locally
   * @param argResolver      The user defined class that resolves the and
   *                         returns the method argument using transport
   *                         context information
   * @param contextInterface The type of transport Context object the callback
   *                         is interested in eg. HttpServletRequest.class for
   ...
   * @param argResolver      The previously registered LocalArgResolver
   *                         object
   * @param contextInterface The previously registered transport Context
   *                         interface.
   */
   ...
   *                  request and response objects in an http servlet call
   *                  environment. These are used to insert local arguments
   *                  (e.g. the request, response or session,etc.) when found
   *                  in the java method call argument signature.
   * @param method    the java method that will later be invoked with the
   *                  given args.
  ...
  /**
   * Add all instance methods that can be invoked on this bridge to a
   * HashSet.
   *
   * @param m HashSet to add all static methods to.
   */
