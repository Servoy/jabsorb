...
public class TestImpl implements Serializable
{
  ...
  public Test.Wiggle echo(Test.Wiggle wiggle)
  {
    return wiggle;
  }

  public Test.Waggle echo(Test.Waggle waggle)
  {
    return waggle;
  }
  ...
  public String wigOrWag(ArrayList al)
  {
    ...
    {
      Object o = i.next();
      if (o instanceof Test.Wiggle)
      {
        Test.Wiggle w = (Test.Wiggle) o;
        buf.append(w + " ");
      }
      else if (o instanceof Test.Waggle)
      {
        Test.Waggle w = (Test.Waggle) o;
        buf.append(w + " ");
      }
      else
      {
  ...
  private static Test.CallableRefTest callableRef = new Test.CallableRefTest();

  public Test.CallableRefTest getCallableRef()
  {
    return callableRef;
  }
